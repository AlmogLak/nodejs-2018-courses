...
const item_logic_1 = require("../../logic/item-logic");
function itemsRouterFactory(itemsWebsocketController) {
    const persistance = new mongo_persistanse_1.MongoPersistance();
    const itemsController = new items_controller_1.ItemsController(persistance, itemsWebsocketController, new item_logic_1.ItemsLogic(persistance));
